...
### Парсинг вложений и OCR

Прайсы из Excel/CSV/PDF парсятся автоматически. Фото прайсов проходят через Tesseract OCR; установите Tesseract локально и при необходимости укажите путь в `backend/.env`:
